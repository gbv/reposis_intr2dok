      ...
      <div class="row">
        ...
        <div class="col-md-2 col-6 col-sm-3">
          ...
          <ul class="social_links">
            <li><a href="https://x.com/FID_intRecht"><img src="{$WebApplicationBaseURL}content/images/logo-X-small.png" alt="X-Logo" style="margin-right:5px;float:left;" />#fid_intrecht</a></li>
